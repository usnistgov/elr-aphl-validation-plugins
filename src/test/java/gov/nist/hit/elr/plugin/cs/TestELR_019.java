...
public class TestELR_019 {
  ...
  /**
   * MSH-21.1 = PHLabReport-Ack, MSH-15 is present and valued 'AL'. No error/alert expected
   * 
   * @throws Exception
   */
  @Test
  ...
  /**
   * MSH-21.1 = PHLabReport-Ack, MSH-15 is present and valued 'NE'. One error, no alert expected
   * 
   * @throws Exception
   */
  @Test
  ...
  /**
   * MSH-21 Not present, MSH-15 present and valued NE. Two errors, no alert expected.
   * 
   * @throws Exception
   */
  @Test
  ...
  /**
   * MSH-21 Not present, MSH-15 present and valued AL. Three errors, no alert expected.
   * 
   * @throws Exception
   */
  @Test
  ...
  /**
   * MSH-21.1 Not present, MSH-15 not present. Two errors, no alert expected. expected.
   * 
   * @throws Exception
   */
  @Test
  ...
  /**
   * MSH-21.1 Not present, MSH-15 present and valued NE. Two errors, no alert expected.
   * 
   * @throws Exception
   */
  @Test
  ...
  /**
   * MSH-21.1 Not present, MSH-15 present and valued AL. Three errors, no alert expected.
   * 
   * @throws Exception
   */
  @Test
  ...
  /**
   * MSH-21.1 Present, but different from PHLabReport-Ack, MSH-15 not valued. No error, no alert
   * expected.
   * 
   * @throws Exception
   */
  ...
  /**
   * MSH-21.1 Present, but different from PHLabReport-Ack, MSH-15 valued 'AL'. One error, no alert
   * expected.
   * 
   * @throws Exception
   */
  ...
  /**
   * MSH-21.1 Present, but different from PHLabReport-Ack, MSH-15 valued 'NE'. No error, no alert
   * expected.
   * 
   * @throws Exception
   */
