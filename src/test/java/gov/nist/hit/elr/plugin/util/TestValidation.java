...
public class TestValidation {
	...
	public void testValidation() throws Exception {
		...
		String globalFolder = "/Candida - Claude";
		...
		String message = "/Candida - Claude/message.txt";
		...
		InputStream messageER7 = getClass().getResourceAsStream(message);
		String text = IOUtils.toString(messageER7, StandardCharsets.UTF_8.name());

		Report report = validator.check(text, "645a74bf8b87bc00075c4db6_ARLN");
