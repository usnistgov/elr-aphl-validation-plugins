...
public class TestARLN_OBX3 {
	...
	public void testCheckSuccess()
		...
		// OBX-3 = 90003-5 LN & OBR-4 = 68991-9 LN

		ComplexCodedElement OBX3_identifier = new ComplexCodedElement("90003-5", "LN", "", "");
		OBX3s.add(OBX3_identifier);
		ComplexCodedElement OBX3_alternate = new ComplexCodedElement("", "", "90003-5", "LN");
		OBX3s.add(OBX3_alternate);
		ComplexCodedElement OBX3_identifier_2 = new ComplexCodedElement("90003-5", "LN", "ABC", "L");
		OBX3s.add(OBX3_identifier_2);
		ComplexCodedElement OBX3_alternate_2 = new ComplexCodedElement("ABC", "L", "90003-5", "LN");
	...
	@Test
	public void testCheckFail() throws IOException, ClassNotFoundException, InterruptedException, URISyntaxException {
