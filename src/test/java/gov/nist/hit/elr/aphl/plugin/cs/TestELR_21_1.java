...
public class TestARLN_21 {
	...
	public void testCheckSuccess() {
		...
		EntityIdentifier ei = new EntityIdentifier("PHLabReport-NoAck", "phLabResultsELRv251", "2.16.840.1.113883.9.11",
				"ISO");
		values.add(ei);
		...
		EntityIdentifier ei_3 = new EntityIdentifier("PHLabReport-NoAck", "Test", "2.16.840.1.113883.9.12", "ISO");
		values.add(ei_3);
		assertTrue(testObject.check(values));
	}
	...
	public void testCheckFail() {
		...
		EntityIdentifier ei_4 = new EntityIdentifier("PHLabReport-NoAck", "", "2.16.840.1.113883.9.11", "ISO");
		values.add(ei_4);
		assertFalse(testObject.check(values));
	}
