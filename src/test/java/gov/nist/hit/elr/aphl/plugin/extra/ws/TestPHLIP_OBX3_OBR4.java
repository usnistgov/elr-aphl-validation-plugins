...
import gov.nist.hit.elr.aphl.plugin.extra.PHLIP_OBX3_OBR4_ws;
...
public class TestPHLIP_OBX3_OBR4 {
  ...
  public static void setUp() {
    testObject = new PHLIP_OBX3_OBR4_ws();
  ...
  @Test
  public void testCheckSuccess2()
      throws IOException, ClassNotFoundException, InterruptedException, URISyntaxException {

    ComplexCodedElement OBX3_identifier = new ComplexCodedElement("94500-6", "LN", "", "");
    OBX3s.add(OBX3_identifier);
