...
import gov.nist.healthcare.elr.custom.util.Util;
...
public class TestELR_020 {
	...
	/**
	 * MSH-21.1 = PHLabReport-Ack, MSH-16 is present and valued 'AL'. No error/alert
	 * expected
	 * 
	 * @throws Exception
	 */
	...
	/**
	 * MSH-21.1 = PHLabReport-Ack, MSH-16 is present and valued 'ER'. No error/alert
	 * alert expected
	 * 
	 * @throws Exception
	 */
	...
	/**
	 * MSH-21 Not present, MSH-16 present and valued NE. Two errors, no alert
	 * expected.
	 * 
	 * @throws Exception
	 */
	...
	/**
	 * MSH-21.1 = PHLabReport-Ack, MSH-16 is present and valued 'AB'. One error, no
	 * alert expected
	 * 
	 * @throws Exception
	 */
	...
	/**
	 * MSH-21.1 = PHLabReport-Ack, MSH-16 is not present. Two errors, no alert
	 * expected
	 * 
	 * @throws Exception
	 */
	...
	/**
	 * MSH-21.1 present, but different from PHLabReport-Ack, MSH-16 is valued 'AL'.
	 * One error, no alert expected.
	 * 
	 * @throws Exception
	 */
	@Test
	...
	/**
	 * MSH-21.1 present, but different from 'PHLabReport-Ack', MSH-16 valued 'NE'.
	 * No error, no alert expected.
	 * 
	 * @throws Exception
	 */
	@Test
	...
	/**
	 * MSH-21.1 present, but different from 'PHLabReport-Ack', MSH-16 not present.
	 * No error, no alert expected.
	 * 
	 * @throws Exception
	 */
