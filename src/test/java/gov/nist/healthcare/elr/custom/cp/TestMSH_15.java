package gov.nist.healthcare.elr.custom.cp;
...
public class TestMSH_15 {
	...
	/**
	 * MSH-21.1 = PHLabReport-Ack, MSH-15 is present. Predicate is true, usage is R.
	...
	/**
	 * MSH-21.1 = PHLabReport-Ack, MSH-15 is absent. Predicate is true, usage is R.
	...
	/**
	 * MSH-21.1 != PHLabReport-Ack, MSH-15 is present. Predicate is false, usage is
	 * RE. No error, no alert expected
	 * 
	 * @throws Exception
	 */
	@Test
	...
	/**
	 * MSH-21.1 != PHLabReport-Ack, MSH-15 is absent. Predicate is false, usage is
	 * RE. No error, no alert expected
	 * 
	 * @throws Exception
	 */
