package gov.nist.healthcare.elr.custom.util;
...
public class Util {
	...
	public static SyncHL7Validator createValidator(String globalProfileFileName, String globalConstraintsFileName,
			File specificConstraintsFile, String globalValueSetLibFileName) throws Exception {
