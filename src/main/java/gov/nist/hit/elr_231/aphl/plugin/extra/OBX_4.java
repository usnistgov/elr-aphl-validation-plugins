package gov.nist.hit.elr_231.aphl.plugin.extra;
...
public class OBX_4 {
	 ...
	 * segments associated with the same OBR segment that have the same OBX-3 values
	 * for (OBX-3.1 and OBX-3.3) or (OBX-3.4 and OBX-3.6).
	 */
	...
	public java.util.List<String> assertionWithCustomMessages(Element e) {
		...
		List<Element> OBXList = Query.query(e, "4[*].1[1]").get();
	...
	public java.util.List<String> check(java.util.List<CodedElement> obx3s, CodedElement obx3, String obx4) {
		java.util.List<String> messages = new java.util.ArrayList<String>();
