...
public class ELR_020 {
	...
	/**
	 * ELR-020: MSH-16 (Application Acknowledgement Type) SHALL contain the constant
	 * value 'AL', 'NE', 'ER', or 'SU', IF any occurrence of MSH-21.1 (Entity
	 * Identifier) is 'PHLabReport-Ack', ELSE, if valued, SHALL contain the constant
	 * value 'NE' .
	 */
