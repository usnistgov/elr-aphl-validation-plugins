...
public abstract class OBX_ws implements OBX {
  ...
  public java.util.List<String> assertionWithCustomMessages(Element e)
    ...
    System.out.println("je rentre dans OBX_ws");
  ...
  public java.util.List<String> checkOBX3(ComplexCodedElement obx3)
    ...
    int indentifierCt =
        Test.findByOBX3(identifier.getIdentifier(), identifier.getCodeSystem(), tests).size();
    int alternateCt =
        Test.findByOBX3(alternate.getIdentifier(), alternate.getCodeSystem(), tests).size();
