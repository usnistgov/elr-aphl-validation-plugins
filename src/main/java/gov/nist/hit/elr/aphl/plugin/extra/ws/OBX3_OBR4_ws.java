	...
	public java.util.List<String> check(ComplexCodedElement OBR4, java.util.List<ComplexCodedElement> OBX3s)
		...
		for (ComplexCodedElement OBX3 : OBX3s) {
			...
			if (!obx3InTests) {
				...
				Observation obsById = Observation.find(identifierOBX3.getIdentifier(), identifierOBX3.getCodeSystem(),
						observations);
				Observation obxByAlt = Observation.find(alternateOBX3.getIdentifier(), alternateOBX3.getCodeSystem(),
						observations);
