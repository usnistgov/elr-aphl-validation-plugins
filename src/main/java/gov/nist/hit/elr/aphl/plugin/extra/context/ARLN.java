...
public class ARLN {
	...
	private static final String PROGRAM_DEFAULT = "ARLN";
	...
	private static final String WEBSERVICE_URL_DEFAULT = "https://aphl.nist.gov/aphl-service/aphl/arln/";
	private static final String VOCAB_WEBSERVICE_URL_DEFAULT = "https://vocab.nist.gov/vocabulary-service/aphl_arln";
	...
	static {
		PROGRAM = getProp("ARLN_PROGRAM", PROGRAM_DEFAULT);
		SPM4_CSV = getProp("ARLN_SPM4_CSV", SPM4_CSV_DEFAULT);
		TEST_CSV = getProp("ARLN_TEST_CSV", TEST_CSV_DEFAULT);
		OBSERVATIONS_CSV = getProp("ARLN_OBSERVATIONS_CSV", OBSERVATIONS_CSV_DEFAULT);
		ORDERS_CSV = getProp("ARLN_ORDERS_CSV", ORDERS_CSV_DEFAULT);
		VALUE_SETS_CSV = getProp("ARLN_VALUE_SETS_CSV", VALUE_SETS_CSV_DEFAULT);
		WEBSERVICE_URL = getProp("ARLN_WEBSERVICE_URL", WEBSERVICE_URL_DEFAULT);
		VOCAB_WEBSERVICE_URL = getProp("ARLN_VOCAB_WEBSERVICE_URL", VOCAB_WEBSERVICE_URL_DEFAULT);
	}
