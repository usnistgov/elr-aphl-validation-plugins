...
public abstract class OBX3_OBR4_Warning_csv implements OBX3_OBR4_Warning {
	...
	public abstract String getORDERS_CSV();
	...
	public java.util.List<String> check(ComplexCodedElement OBR4, java.util.List<ComplexCodedElement> OBX3s)
		...
		util.parse(getTEST_CSV(), getOBSERVATIONS_CSV(), getORDERS_CSV(), getVALUE_SETS_CSV());
		...
		for (ComplexCodedElement OBX3 : OBX3s) {
			...
			if (obx3InTests) {
				...
				CodedElement obx4 = util.getOBR4_OBX3().containsKey(identifierOBR4) ? identifierOBR4 : alternateOBR4;
			...
			if (!obx3InTests) {
				...
				CodedElement obx3 = util.getOBX3().contains(identifierOBX3) ? identifierOBX3 : alternateOBX3;
				CodedElement obx4 = util.getOBR4_OBX3().containsKey(identifierOBR4) ? identifierOBR4 : alternateOBR4;
